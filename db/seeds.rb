...
file1 = open("https://FunReads-seeds.s3-us-west-1.amazonaws.com/American_Spy_By_Lauren_wilkinson.png")
...
file = open("https://FunReads-seeds.s3-us-west-1.amazonaws.com/Book-of-Strange-New-Things.jpg")
...
file = open("https://FunReads-seeds.s3-us-west-1.amazonaws.com/upright_woman_wanted.jpeg")
...
book4 = Book.create(
    ...
    # cover_image_url: open('https://FunReads-seeds./Elizabeth_Gilbert_by_city_of_girls.png'),
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/Elizabeth_Gilbert_by_city_of_girls.png')
...
book5 = Book.create(
    ...
    genre: Faker::Book.genre,
    # cover_image_url: open('https://FunReads-seeds./Maybe_You_Should_Talk_To_Someone_by_Lori_Gottlieb.png'),
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/Maybe_You_Should_Talk_To_Someone_by_Lori_Gottlieb.png')
...
book6 = Book.create(
    ...
    genre: Faker::Book.genre,
    # cover_image_url: open('https://FunReads-seeds./The_Names_of_the_dead_by_Kevin_wignall.png'),
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/The_Names_of_the_dead_by_Kevin_wignall.png')
...
book7 = Book.create(
    ...
    genre: Faker::Book.genre,
    # cover_image_url: open('https://FunReads-seeds./Salman_Rushdie_by_Quichotte.png'),
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/Salman_Rushdie_by_Quichotte.png')
...
book8 = Book.create(
    ...
    genre: Faker::Book.genre,
    # cover_image_url: open('https://FunReads-seeds./Swanns_Way_by_Marcel_Proust.png'),
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/Swanns_Way_by_Marcel_Proust.png')
...
book9 = Book.create(
    ...
    author: "Mike Isaac",
    genre: Faker::Book.genre,
    # cover_image_url: open('https://FunReads-seeds.s3-us-west-1.amazonaws.com//Super_Pumped_by_Mike_Issac.png'),
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/Super_Pumped_by_Mike_Isaac.png')
...
book10 = Book.create(
    ...
    genre: Faker::Book.genre,
    # cover_image_url: open('https://FunReads-seeds.s3-us-west-1.amazonaws.com//The_Nickel_Boys_by_Colson_Whitehead.png'),
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/The_Nickel_Boys_by_Colson_Whitehead.png')
...
book11 = Book.create(
    ...
    genre: Faker::Book.genre,
    # cover_image_url: open('https://FunReads-seeds.s3-us-west-1.amazonaws.com//The_starless_sea_by_erin_morgenstern.png') ,
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/The_starless_sea_by_erin_morgenstern.png')
...
book12 = Book.create(
    ...
    author: "Atwood",
    genre: Faker::Book.genre,
    # cover_image_url: open('https://FunReads-seeds.s3-us-west-1.amazonaws.com//The_Testaments_by_Atwood.png'),
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/The_Testaments_by_Atwood.png')
...
book13 = Book.create(
    ...
    author: "George Takei",
    genre: Faker::Book.genre,
    # cover_image_url: open('https://FunReads-seeds.s3-us-west-1.amazonaws.com//They_Called_us_enemy_by_Georege_takei.png'),
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/They_Called_us_enemy_by_Georege_takei.png')
...
book14 = Book.create(
    ...
    genre: Faker::Book.genre,
    # cover_image_url: open('https://FunReads-seeds.s3-us-west-1.amazonaws.com//Wild_Game_by_Adrienne_Brodeur.png'),
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/Wild_Game_by_Adrienne_Brodeur.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/bad_blood.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/All_you_have_to_do_is_ask.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/the_attention_merchants.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/beaten_down_worked_up.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/call_sign.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/the_culture_code.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/decolonizing_wealth.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/designing_life.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/the_five_languages.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/the_power_of_the_other.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/integrity.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/leadership.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/arguing_with_zombies.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/baking_bible.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/how_to_bake.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/black_wave.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/the_victory.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/unnamed_midwife.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/sisters_grave.png')
...
file = open('https://FunReads-seeds.s3-us-west-1.amazonaws.com/killer_mind.png')
